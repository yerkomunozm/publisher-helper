...
Sistema de marketing personal: convierte notas de voz en newsletter + captions de Instagram publicadas en Metricool.
...
- **`brand_voice.md`** — voz, tono, ejemplos de textos reales, reglas por canal (Instagram y newsletter). Es la fuente de verdad para el redactor y el revisor. Mejora añadiendo fragmentos que hayan funcionado bien.
...
|---|---|---|
| `redactor` | sonnet | Siempre. Genera `output/newsletter-YYYY-MM-DD.md` y `output/instagram-YYYY-MM-DD.md` |
...
El revisor devuelve **únicamente JSON** — si hay texto adicional, es un error del agente. El publicador programa Instagram en Metricool; la newsletter queda en `output/` para publicación manual (no hay integración con Substack/email).
...
- `instagram-YYYY-MM-DD.md` — 3 captions con ángulos conceptual, práctico y personal
